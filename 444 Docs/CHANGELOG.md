...
Use this file to track presentations processed, notes added, and structural changes.

| Date | Category | Description |
| :--- | :--- | :--- |
| 2026-02-26 | Enhancement | [EXPANDED] Activation Functions: Added advantages/disadvantages for each function (Step, Sigmoid, ReLU, Gaussian). Added Tanh section. Added context on role of f'(s) in backpropagation weight updates. Updated Nonlinear Neuron to list Tanh. |
...
| 2026-01-29 | Presentation | Deep Learning: Processed 4 lectures on neural networks, learning algos, and clustering. |
| 2026-01-29 | Presentation | Probability: Processed Days 2-6 (Bayes' Rule, Independence, Sample Spaces). |
| YYYY-MM-DD | Presentation | Added notes from `Prob_Lecture1.pptx` |
| YYYY-MM-DD | Structure | Created `CLAUDE.md` and `docs/vault_documentation.md` |
